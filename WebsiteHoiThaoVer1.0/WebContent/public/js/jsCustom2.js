...
$(document).ready(function(){
  ...
  $('.doan').pageMe({pagerSelector:'#myPager',showPrevNext:true,hidePageNumbers:false,perPage:10});
...
//	});
	$('#tblriview tbody tr td').click(function (e) {
		...
		$('#namepostt').val($(this).closest('tr').find('td:eq(2)').text()); 
		$('#nameauthorr').val($(this).closest('tr').find('td:eq(1)').text()); 
		$('#summaryy').val($(this).closest('tr').find('td:eq(3)').text()); 
	});
