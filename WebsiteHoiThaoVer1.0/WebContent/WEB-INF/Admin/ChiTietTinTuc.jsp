<%@page import="Models.SuKienModels"%>
...
<body>
	...
	<div class="page-panel">
		<div class="container news">
			<%
				if (request.getAttribute("SuKien") != null) {
					SuKienModels events=(SuKienModels) request.getAttribute("SuKien");
			%>
				<h1><%= events.getTenSuKien()%></h1>
			<div class="row">
				<div class="col-md-8 col-xs-12">
					<p><%=events.getNoiDung() %></p>
				</div>
				<div class="col-md-4 col-xs-12">
					<img src=<%=events.getHinh() %> class="img-responsive">
				</div>
			</div>
			<hr>
			<div class="row">
				...
				<div class="col-md-8 col-xs-12">
					<p>Ngày bắt đầu : <%=events.getNgayBatDauSuKien() %></p>
					<p>Ngày kết thúc : <%=events.getNgayKetThucSuKien() %></p>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-12">
					<img src="./public/images/1.jpg" class="img-responsive">
				</div>
			</div>
			<hr>
			<div class="row">
