...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					%>
					<li><a href="${pageContext.request.contextPath}/DangKyTaiKhoan"><span class="fa fa-sign-in"></span> Đăng
							kí</a></li>
					<li><a
					...
					%>
					<li><a
						href="${pageContext.request.contextPath}/TrangCaNhanControllers"><%=request.getSession().getAttribute("TenNguoiDung")%></a></li>
					<li><a
						href="${pageContext.request.contextPath}/DangXuatControllers"><span
							class="fa fa-sign-out"></span> Đăng Xuất</a></li>
					<%
						}
					%>
				</ul>
						...
						<div class="container">
							<div class="col-md-3 text-right">
								<img style="max-width: 200px;"
									...
									src="./public/images/home/window-domain.png" class="resp">
							</div>
					...
					<div class="row">
						<div class="container">
							...
							<div class="col-md-5 text-right">
								<img style="max-width: 200px;"
									data-animation="animated zoomInLeft"
									src="./public/images/home/rack-server-unlock.png" class="resp">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="container">
							...
							<div class="col-md-5 text-right">
								<img style="max-width: 200px;"
									data-animation="animated zoomInLeft"
									src="./public/images/home/globe-network.png" class="resp">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="container">
							...
							<div class="col-md-5 text-right">
								<img style="max-width: 200px;"
									data-animation="animated zoomInLeft"
									src="./public/images/home/internet-speed.png" class="resp">
							</div>
						</div>
					</div>
				</div>
	...
	<script src="./public/js/chude2.js"></script>
</body>
