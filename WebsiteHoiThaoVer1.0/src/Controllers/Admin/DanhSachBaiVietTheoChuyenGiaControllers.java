...
/**
 * Servlet implementation class DanhSachBaiVietTheoChuyenGiaControllers
 */
@WebServlet("/DanhSachBaiVietTheoChuyenGiaControllers")
public class DanhSachBaiVietTheoChuyenGiaControllers extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DanhSachBaiVietTheoChuyenGiaControllers() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ReviewModel> dsBaiViet = ReviewDAL.DanhSachBaiReview(maNguoiDung, maChuDe, maTrangThai);
